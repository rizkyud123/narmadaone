...
if ( ! class_exists( 'News_Portal_Control_Radio_Image' ) ) :
    
    /**
	 * Radio Image control (modified radio).
     *
     */
	class News_Portal_Control_Radio_Image extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_style( 'np-radio-image', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radio-image.css', null, NEWS_PORTAL_VERSION );
            wp_enqueue_script( 'np-radio-image', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radio-image.js', array( 'jquery' ), NEWS_PORTAL_VERSION, true );
        }

...
class Wpmagazine_Modules_Lite_Post_Grid_Element extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-grid-block-'.esc_attr( $element_id ).'" class="wpmagazine-modules-lite-post-grid-block block-'.esc_attr( $element_id ).' cvmm-block cvmm-block-post-grid--'.esc_attr( $blockLayout ).'">';
            if ( !empty( $blockTitle ) ) {

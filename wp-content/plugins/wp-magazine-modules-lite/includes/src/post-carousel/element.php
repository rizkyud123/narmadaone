...
class Wpmagazine_Modules_Lite_Post_Carousel_Element extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-carousel-block-'.esc_attr( $element_id ).'" class="wpmagazine-modules-lite-post-carousel-block block-'.esc_attr( $element_id ).' cvmm-block cvmm-block-post-carousel--'.esc_html( $blockLayout ).'">';
            if ( !empty( $blockTitle ) ) {

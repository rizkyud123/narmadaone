...
class Wpmagazine_Modules_Lite_Post_List_Element extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-list-block-'.esc_attr( $element_id ).'" class="wpmagazine-modules-lite-post-list-block block-'.esc_attr( $element_id ).' cvmm-block cvmm-block-post-list--'.esc_attr( $blockLayout ).'">';
            if ( !empty( $blockTitle ) ) {

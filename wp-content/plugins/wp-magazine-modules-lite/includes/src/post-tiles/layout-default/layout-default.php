        ...
        ?>
                <article post-id="post-<?php echo esc_attr( $post_id ); ?>" class="cvmm-post post-format--<?php echo esc_attr( $post_format ); ?>" itemscope itemtype="<?php echo esc_url( 'http://schema.org/articleBody' ); ?>">
                    ...
                    <div class="cvmm-post-thumb">
                        <a href="<?php the_permalink(); ?>" target="<?php echo esc_attr( $permalinkTarget ); ?>" style="background: url( <?php echo esc_url( $image_url ); ?> ); background-position: <?php echo esc_attr( $sliderImagePosition ); ?>; background-size: <?php echo esc_attr( $sliderImageSize ); ?>">
                        </a>
                    </div>

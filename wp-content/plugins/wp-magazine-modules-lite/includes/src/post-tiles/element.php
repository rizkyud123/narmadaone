...
class Wpmagazine_Modules_Lite_Post_Tiles_Element extends \Elementor\Widget_Base {
    ...
    ?>
        <div id="wpmagazine-modules-lite-post-tiles-block-<?php echo esc_attr( $element_id ); ?>" class="wpmagazine-modules-lite-post-tiles-block block-<?php echo esc_attr( $element_id ); ?> cvmm-block cvmm-block-post-tiles--<?php echo esc_attr( $blockLayout ); ?>">
            <?php
                if ( !empty( $blockTitle ) ) {

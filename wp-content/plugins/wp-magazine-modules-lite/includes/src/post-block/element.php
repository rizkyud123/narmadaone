...
class Wpmagazine_Modules_Lite_Post_Block_Element extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-block--block-'.esc_attr( $element_id ).'" class="wpmagazine-modules-lite-post-block--block block-'.esc_attr( $element_id ).' cvmm-block cvmm-block-post-block--'.esc_attr( $blockLayout ).'">';
            if ( !empty( $blockTitle ) ) {

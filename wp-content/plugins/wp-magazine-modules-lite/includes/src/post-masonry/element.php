...
class Wpmagazine_Modules_Lite_Post_Masonry_Element extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-masonry-block-'.esc_attr( $element_id ).'" class="wpmagazine-modules-lite-post-masonry-block block-'.esc_attr( $element_id ).' cvmm-block cvmm-block-post-masonry--'.esc_attr( $blockLayout ).'">';
            if ( !empty( $blockTitle ) ) {
